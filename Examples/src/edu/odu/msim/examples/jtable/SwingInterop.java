package edu.odu.msim.examples.jtable;
 ...
 */
 public class SwingInterop extends JApplet 
 {
    ...
    private static SimpleMatrixTableModel tableModel;
    private Chart chart;


    @Override
    public void init() {
        tableModel = new SimpleMatrixTableModel();
        ...
        tableModel.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent e) {
                if (e.getType() == TableModelEvent.UPDATE) {
                    ...
                    final Object value = ((SimpleMatrixTableModel) e.getSource()).getValueAt(row, column);
